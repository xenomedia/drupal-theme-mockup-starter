...
window.WebFontConfig={google:{families:["Roboto:400,400i,700,700i:latin"]},timeout:2e3};
// Create & inject Google's web font loader:
var b=document.createElement("script");b.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",b.async="true",document.head.appendChild(b)}(window),/* check if browser is IE10 */
navigator.userAgent.match("MSIE 10.0;")&&$("html").addClass("lt-ie11 ie10"),/*
================================================
